...
/*   Updated: 2026/04/23 13:34:50 by yben-dje         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*render_prompt(char *base_prompt, t_minishell *minishell)
{
	...
	{
		if ((base_prompt[index] == '%' || base_prompt[index] == '!') && base_prompt[index + 1] && base_prompt[index + 2])
		{
		...
		else if (base_prompt[index] == '\\' && (base_prompt[index + 1] == '%' || base_prompt[index + 1] == '!'))
		{
