...
/*   Updated: 2026/03/26 16:56:52 by lchamard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	exec_cmd(t_btree_node *tree, t_vec *expr, int files[2], char **env)
{
	t_pipex		pipex_var;
	t_pid_list	pid_list;

	vec_to_cmd(tree, expr, env);
	pipex_var = cmd_to_pipex(tree->cmds, files, env);
...
int	exec_pipeline(t_btree_node *tree, t_vec *expr, int files[2], char **env)
{
	t_pid_list	pid;
